-- Script básico para criar apenas as tabelas essenciais para o módulo financeiro
-- Execute este script no seu banco de dados Supabase

-- 1. Primeiro, vamos adicionar as colunas que faltam na tabela towing_partners (se ela existe)
ALTER TABLE towing_partners 
ADD COLUMN IF NOT EXISTS external_access_token VARCHAR(255),
ADD COLUMN IF NOT EXISTS company_name VARCHAR(255),
ADD COLUMN IF NOT EXISTS email VARCHAR(255);

-- 2. Criar a tabela towing_services (que não existe)
...
-- 3. Inserir alguns parceiros básicos se não existirem
INSERT INTO towing_partners (name, phone, company_name, email, external_access_token, "isActive") VALUES
('Claudio Silva', '(11) 99999-0001', 'Guincho Express', 'claudio@teste.com', 'TOKEN_001', true),
('Maria Santos', '(11) 99999-0002', 'Reboque Rápido', 'maria@teste.com', 'TOKEN_002', true),
('João Silva', '(11) 99999-0003', 'Guincho 24h', 'joao@teste.com', 'TOKEN_003', true)
ON CONFLICT DO NOTHING;

-- 4. Inserir alguns serviços aprovados para testar o módulo financeiro
...
-- 7. Resumo financeiro para o módulo
SELECT 
