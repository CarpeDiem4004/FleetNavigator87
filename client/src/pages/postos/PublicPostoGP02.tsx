...
export default function PublicPostoGP02() {
  ...
  const loadFuelHistory = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/historico-direto/GP02');
      if (response.ok) {
    ...
    try {
      const response = await fetch('/api/abastecimento-direto', {
        ...
        body: JSON.stringify({
          ...
          posto_origem: 'GP02',
          operador: operatorInfo?.name || 'Operador GP02',
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">GP02 - JACAREI</h1>
              <p className="text-gray-600">GRUPO PEREIRA | Jacarei, SP</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            <div className="flex items-center gap-1">
              ...
              <span>Operador: {operatorInfo?.name || 'Operador GP02'}</span>
            </div>
            <div className="flex items-center gap-1">
