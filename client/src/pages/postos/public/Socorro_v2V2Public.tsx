/**
 * Página pública de redirecionamento para o Posto Socorro V2
...
const Socorro_v2V2Public: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-md">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-center">Posto Socorro V2 Desativado</CardTitle>
        ...
        <CardContent>
          <Alert variant="warning" className="mb-4">
            ...
            <AlertDescription>
              O Posto Socorro V2 foi desativado em Maio/2025. 
...
export default Socorro_v2V2Public;
