...
/**
 * Página pública de redirecionamento para o posto ABC (removido)
 * Esta página foi mantida para compatibilidade com links antigos
 * Redireciona para a página pública do posto Osasco V2
 */
const ABCPublic: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setLocation(`/posto/${POSTO_OSASCO_V2}/public`);
    }, 5000);
  ...
  return (
    <div className="container mx-auto mt-10 p-6">
      ...
      <div className="flex justify-center mt-6">
        <Button 
          onClick={() => setLocation(`/posto/${POSTO_OSASCO_V2}/public`)}
          size="lg"
          className="mr-4"
        >
