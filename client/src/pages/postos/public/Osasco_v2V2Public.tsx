/**
 * Página pública de redirecionamento para o Posto Osasco V2
...
const Osasco_v2V2Public: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-md">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-center">Posto Osasco V2 Desativado</CardTitle>
        ...
        <CardContent>
          <Alert variant="warning" className="mb-4">
            ...
            <AlertDescription>
              O Posto Osasco V2 foi desativado em Maio/2025. 
...
export default Osasco_v2V2Public;
