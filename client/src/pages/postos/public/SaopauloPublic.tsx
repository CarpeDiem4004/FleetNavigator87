/**
 * Página pública de redirecionamento para o Posto São Paulo V1
...
const SaopauloPublic: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-md">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-center">Posto São Paulo V1 Desativado</CardTitle>
        ...
        <CardContent>
          <Alert variant="warning" className="mb-4">
            ...
            <AlertDescription>
              O Posto São Paulo V1 foi desativado em Maio/2025. 
