...
export default function PublicPostoGP03() {
  ...
  const loadFuelHistory = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/historico-direto/GP03');
      if (response.ok) {
    ...
    try {
      const response = await fetch('/api/abastecimento-direto', {
        ...
        body: JSON.stringify({
          ...
          posto_origem: 'GP03',
          operador: operatorInfo?.name || 'Operador GP03',
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">GP03 - HORTOLANDIA</h1>
              <p className="text-gray-600">GRUPO PEREIRA | Hortolandia, SP</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            <div className="flex items-center gap-1">
              ...
              <span>Operador: {operatorInfo?.name || 'Operador GP03'}</span>
            </div>
            <div className="flex items-center gap-1">
