/**
 * Página de redirecionamento para o Posto Campinas V1
...
const Campinas: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-md">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-center">Posto Campinas V1 Desativado</CardTitle>
        ...
        <CardContent>
          <Alert variant="warning" className="mb-4">
            ...
            <AlertDescription>
              O Posto Campinas V1 foi desativado em Maio/2025. 
