/**
 * Página de redirecionamento para o Posto Guarulhos V1
...
const Guarulhos: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-md">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-center">Posto Guarulhos V1 Desativado</CardTitle>
        ...
        <CardContent>
          <Alert variant="warning" className="mb-4">
            ...
            <AlertDescription>
              O Posto Guarulhos V1 foi desativado em Maio/2025. 
