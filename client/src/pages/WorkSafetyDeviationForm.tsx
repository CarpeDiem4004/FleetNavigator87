...
import { AlertTriangle, ArrowLeft, CheckCircle, Shield, Truck, User, Loader2, Calendar, Search, ChevronsUpDown, Check, FileText, AlertCircle } from 'lucide-react';
...
export default function WorkSafetyDeviationForm() {
          ...
          <Card className="border-t-4 border-t-green-500">
            <CardContent className="pt-12 text-center">
              ...
              <p className="text-gray-600 mb-8">
                O registro foi salvo e será analisado pela equipe de Segurança do Trabalho.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                }} className="bg-[#DB0145] hover:bg-[#B50139]">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="mb-6">
          <Link href="/work-safety/portal">
            <Button variant="ghost" size="sm" className="text-gray-600 hover:text-[#DB0145]">
              <ArrowLeft className="h-4 w-4 mr-2" />
              Voltar ao Portal
            </Button>
          </Link>
        ...
        <Card className="border-t-4 border-t-[#DB0145]">
          <CardHeader className="text-center pb-6">
            <div className="flex justify-center mb-4">
              <div className="p-4 bg-gradient-to-br from-[#DB0145] to-[#B50139] rounded-full">
                <AlertTriangle className="h-10 w-10 text-white" />
              </div>
            </div>
            <CardTitle className="text-2xl text-gray-900">
              Registro de Desvio de Motorista
            </CardTitle>
            <CardDescription className="text-base mt-2">
              Registre desvios operacionais e comportamentais para acompanhamento
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 mt-1">
                      ...
                      Motoristas reincidentes são sinalizados automaticamente pelo sistema.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                className="w-full bg-[#DB0145] hover:bg-[#B50139] h-12 text-lg"
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Murici Transportes - Segurança do Trabalho
        </p>
      </div>
    </div>
  );
