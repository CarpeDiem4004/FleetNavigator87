...
const LoginPocosCaldas: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base POÇOS DE CALDAS SMG5...",
        });
        navigate('/bases/pocos-caldas');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            POÇOS DE CALDAS SMG5 SMG5
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base POÇOS DE CALDAS SMG5
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPocosCaldas;