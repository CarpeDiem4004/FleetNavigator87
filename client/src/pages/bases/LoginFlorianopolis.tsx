...
const LoginFlorianopolis: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base FLORIANÓPOLIS SSC2...",
        });
        navigate('/bases/florianopolis');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            FLORIANÓPOLIS SSC2 SSC2
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base FLORIANÓPOLIS SSC2
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginFlorianopolis;