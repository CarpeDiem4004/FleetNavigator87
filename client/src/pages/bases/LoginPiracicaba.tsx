...
const LoginPiracicaba: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PIRACICABA SSP36...",
        });
        navigate('/bases/piracicaba');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PIRACICABA SSP36 SSP36
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PIRACICABA SSP36
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPiracicaba;