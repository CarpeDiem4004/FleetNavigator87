    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base SÃO CARLOS SSP22...",
        });
        navigate('/bases/sao-carlos');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            SÃO CARLOS SSP22 SSP22
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base SÃO CARLOS SSP22
          </p>
        </CardHeader>
        <CardContent>
