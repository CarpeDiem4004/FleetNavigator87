...
const LoginMegaGuarulhos: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base MEGA GUARULHOS SSP30...",
        });
        navigate('/bases/mega-guarulhos');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            MEGA GUARULHOS SSP30 SSP30
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base MEGA GUARULHOS SSP30
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginMegaGuarulhos;