    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PRESIDENTE PRUDENTE SSP11...",
        });
        navigate('/bases/presidente-prudente');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PRESIDENTE PRUDENTE SSP11 SSP11
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PRESIDENTE PRUDENTE SSP11
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPresidentePrudente;