    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base ARACATUBA SSP10...",
        });
        navigate('/bases/aracatuba');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            ARACATUBA SSP10 SSP10
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base ARACATUBA SSP10
          </p>
        </CardHeader>
        <CardContent>
