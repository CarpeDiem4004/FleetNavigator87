...
const LoginPortoAlegre: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PORTO ALEGRE SRS1...",
        });
        navigate('/bases/porto-alegre');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PORTO ALEGRE SRS1 SRS1
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PORTO ALEGRE SRS1
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPortoAlegre;