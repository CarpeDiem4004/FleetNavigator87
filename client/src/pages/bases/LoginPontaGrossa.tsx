...
const LoginPontaGrossa: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PONTA GROSSA SPR7...",
        });
        navigate('/bases/ponta-grossa');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PONTA GROSSA SPR7 SPR7
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PONTA GROSSA SPR7
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPontaGrossa;