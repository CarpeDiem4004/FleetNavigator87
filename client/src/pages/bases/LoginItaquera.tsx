    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base ITAQUERA SSP45...",
        });
        navigate('/bases/itaquera');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            ITAQUERA SSP45 SSP45
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base ITAQUERA SSP45
          </p>
        </CardHeader>
        <CardContent>
