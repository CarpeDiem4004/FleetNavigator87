  ...
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/sp/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/sp/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base São Paulo
          </p>
        </div>
