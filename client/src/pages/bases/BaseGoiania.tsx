  ...
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/goiania/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/goiania/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/goiania/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
    ...
    },
    {
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/goiania/configuracoes",
      status: "Ativo"
    }
  ];
