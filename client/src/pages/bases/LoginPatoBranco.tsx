...
const LoginPatoBranco: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PATO BRANCO SPR4...",
        });
        navigate('/bases/pato-branco');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PATO BRANCO SPR4 SPR4
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PATO BRANCO SPR4
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPatoBranco;