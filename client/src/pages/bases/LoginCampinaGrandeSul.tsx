...
const LoginCampinaGrandeSul: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base CAMPINA GRANDE DO SUL SPR8...",
        });
        navigate('/bases/campina-grande-sul');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            CAMPINA GRANDE DO SUL SPR8 SPR8
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base CAMPINA GRANDE DO SUL SPR8
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginCampinaGrandeSul;