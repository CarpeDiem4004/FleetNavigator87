    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="text-center flex-1">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">
              Base GP01 - Vargem Grande
            </h1>
            <p className="text-lg text-gray-600">
              Gerenciamento completo da Base GP01
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow">
            ...
            <CardContent className="p-4">
              ...
              <a href="/posto/gp01/public" target="_blank" rel="noopener noreferrer">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow">
            ...
            <CardContent className="p-4">
              <p className="text-sm text-gray-600 mb-4">
                Cadastre, atualize e gerencie os veículos da Base GP01. Registre modelos, placas, status operacional e informações técnicas.
              </p>
              <a href="/posto/gp01/public" target="_blank" rel="noopener noreferrer">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow">
            ...
            <CardContent className="p-4">
              ...
              <Link href="/bases/gp01/cartao-combustivel">
        ...
        <div className="text-center mt-12 text-sm text-gray-500">
          <p>Base GP01 - Vargem Grande • Grupo Pereira</p>
