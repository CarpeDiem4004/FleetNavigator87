  ...
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/vitoria/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/vitoria/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/vitoria/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
    ...
    },
    {
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/vitoria/configuracoes",
      status: "Ativo"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base Vitória
          </p>
        </div>
