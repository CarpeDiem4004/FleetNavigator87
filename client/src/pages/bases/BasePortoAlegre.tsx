  ...
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/porto-alegre/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
      ...
      icon: AlertTriangle,
      color: "bg-red-500",
      link: "/bases/porto-alegre/sinistros",
      status: "Ativo"
    },
    {
      id: 3,
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/porto-alegre/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/porto-alegre/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
      ...
      icon: FileText,
      color: "bg-purple-500",
      link: "/bases/porto-alegre/relatorios",
      status: "Ativo"
    },
    {
      id: 6,
      ...
      icon: Shield,
      color: "bg-yellow-500",
      link: "/bases/porto-alegre/multas",
      status: "Ativo"
    },
    {
      id: 7,
      ...
      icon: DollarSign,
      color: "bg-indigo-500",
      link: "/bases/porto-alegre/financeiro",
      status: "Ativo"
    },
    {
      id: 8,
      ...
      icon: Truck,
      color: "bg-teal-500",
      link: "/bases/porto-alegre/veiculos",
      status: "Ativo"
    },
    {
      id: 9,
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/porto-alegre/configuracoes",
      status: "Ativo"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            SC (PORTO ALEGRE) SRS1
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base Porto Alegre
          </p>
        </div>
