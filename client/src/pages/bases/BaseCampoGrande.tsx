...
const BaseCampoGrande: React.FC = () => {
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/campo-grande/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
      ...
      icon: AlertTriangle,
      color: "bg-red-500",
      link: "/bases/campo-grande/sinistros",
      status: "Ativo"
    },
    {
      id: 3,
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/campo-grande/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/campo-grande/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
      ...
      icon: FileText,
      color: "bg-purple-500",
      link: "/bases/campo-grande/relatorios",
      status: "Ativo"
    },
    {
      id: 6,
      ...
      icon: Shield,
      color: "bg-yellow-500",
      link: "/bases/campo-grande/multas",
      status: "Ativo"
    },
    {
      id: 7,
      ...
      icon: DollarSign,
      color: "bg-indigo-500",
      link: "/bases/campo-grande/financeiro",
      status: "Ativo"
    },
    {
      id: 8,
      ...
      icon: Truck,
      color: "bg-teal-500",
      link: "/bases/campo-grande/veiculos",
      status: "Ativo"
    },
    {
      id: 9,
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/campo-grande/configuracoes",
      status: "Ativo"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base Campo Grande
          </p>
        </div>
...
export default BaseCampoGrande;