...
const LoginMogiCruzes: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base MOGI DAS CRUZES SSP23...",
        });
        navigate('/bases/mogi-cruzes');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            MOGI DAS CRUZES SSP23 SSP23
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base MOGI DAS CRUZES SSP23
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginMogiCruzes;