...
const BaseCaraguatatuba: React.FC = () => {
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/caraguatatuba/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
      ...
      icon: AlertTriangle,
      color: "bg-red-500",
      link: "/bases/caraguatatuba/sinistros",
      status: "Ativo"
    },
    {
      id: 3,
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/caraguatatuba/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/caraguatatuba/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
      ...
      icon: FileText,
      color: "bg-purple-500",
      link: "/bases/caraguatatuba/relatorios",
      status: "Ativo"
    },
    {
      id: 6,
      ...
      icon: Shield,
      color: "bg-yellow-500",
      link: "/bases/caraguatatuba/multas",
      status: "Ativo"
    },
    {
      id: 7,
      ...
      icon: DollarSign,
      color: "bg-indigo-500",
      link: "/bases/caraguatatuba/financeiro",
      status: "Ativo"
    },
    {
      id: 8,
      ...
      icon: Truck,
      color: "bg-teal-500",
      link: "/bases/caraguatatuba/veiculos",
      status: "Ativo"
    },
    {
      id: 9,
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/caraguatatuba/configuracoes",
      status: "Ativo"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            SC (CARAGUATATUBA) SSP16
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base Caraguatatuba
          </p>
        </div>
...
export default BaseCaraguatatuba;