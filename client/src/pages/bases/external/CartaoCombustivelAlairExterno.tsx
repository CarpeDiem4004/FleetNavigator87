...
const CartaoCombustivelAlairExterno: React.FC = () => {
        ...
        <Card className="w-full max-w-md shadow-lg">
          ...
          <CardContent className="text-center">
            <p className="text-gray-600 mb-6">
              A equipe da Base Alair analisará sua solicitação e entrará em contato em breve.
            </p>
            <Button 
...
export default CartaoCombustivelAlairExterno;