    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base JOINVILLE SSC1...",
        });
        navigate('/bases/joinville');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <p className="text-gray-600">
            Faça login para acessar a Base JOINVILLE SSC1
          </p>
        </CardHeader>
        <CardContent>
