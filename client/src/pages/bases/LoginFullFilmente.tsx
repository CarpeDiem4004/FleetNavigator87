...
const LoginFullFilmente: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base FULL FILMENTE FULL...",
        });
        navigate('/bases/full-filmente');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            FULL FILMENTE FULL FULL
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base FULL FILMENTE FULL
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginFullFilmente;