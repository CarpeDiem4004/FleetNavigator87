...
const LoginSaoJoseCampos: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base SÃO JOSÉ DOS CAMPOS SSP8...",
        });
        navigate('/bases/sao-jose-campos');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            SÃO JOSÉ DOS CAMPOS SSP8 SSP8
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base SÃO JOSÉ DOS CAMPOS SSP8
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginSaoJoseCampos;