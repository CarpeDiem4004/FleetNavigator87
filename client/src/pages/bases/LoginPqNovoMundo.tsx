...
const LoginPqNovoMundo: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PQ NOVO MUNDO SSP40...",
        });
        navigate('/bases/pq-novo-mundo');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PQ NOVO MUNDO SSP40 SSP40
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PQ NOVO MUNDO SSP40
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPqNovoMundo;