...
const LoginCaraguatatuba: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base CARAGUATATUBA SSP16...",
        });
        navigate('/bases/caraguatatuba');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            CARAGUATATUBA SSP16 SSP16
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base CARAGUATATUBA SSP16
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginCaraguatatuba;