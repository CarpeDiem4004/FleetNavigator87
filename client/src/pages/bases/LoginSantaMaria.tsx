...
const LoginSantaMaria: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base SANTA MARIA SRS3...",
        });
        navigate('/bases/santa-maria');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            SANTA MARIA SRS3 SRS3
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base SANTA MARIA SRS3
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginSantaMaria;