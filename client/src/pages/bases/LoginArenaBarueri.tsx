...
const LoginArenaBarueri: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base ARENA BARUERI SSP5...",
        });
        navigate('/bases/arena-barueri');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            ARENA BARUERI SSP5 SSP5
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base ARENA BARUERI SSP5
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginArenaBarueri;