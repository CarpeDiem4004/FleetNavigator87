...
const LoginDivinopolis: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base DIVINÓPOLIS SMG10...",
        });
        navigate('/bases/divinopolis');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            DIVINÓPOLIS SMG10 SMG10
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base DIVINÓPOLIS SMG10
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginDivinopolis;