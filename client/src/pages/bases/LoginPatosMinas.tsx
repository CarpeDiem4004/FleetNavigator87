...
const LoginPatosMinas: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base PATOS MINAS SMG11-SDD...",
        });
        navigate('/bases/patos-minas');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            PATOS MINAS SMG11-SDD SMG11-SDD
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base PATOS MINAS SMG11-SDD
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginPatosMinas;