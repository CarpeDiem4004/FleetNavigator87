...
const LoginCampinasS7: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base CAMPINAS S7 SSP37...",
        });
        navigate('/bases/campinas-s7');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            CAMPINAS S7 SSP37 SSP37
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base CAMPINAS S7 SSP37
          </p>
        </CardHeader>
        <CardContent>
...
export default LoginCampinasS7;