  ...
  const functionalities = [
    {
      ...
      icon: CreditCard,
      color: "bg-blue-500",
      link: "/bases/fortaleza/cartao-combustivel",
      status: "Ativo"
    },
    {
      id: 2,
      ...
      icon: AlertTriangle,
      color: "bg-red-500",
      link: "/bases/fortaleza/sinistros",
      status: "Ativo"
    },
    {
      id: 3,
      ...
      icon: Clock,
      color: "bg-orange-500",
      link: "/bases/fortaleza/acidentes-trabalho",
      status: "Ativo"
    },
    {
      id: 4,
      ...
      icon: Users,
      color: "bg-green-500",
      link: "/bases/fortaleza/colaboradores",
      status: "Ativo"
    },
    {
      id: 5,
      ...
      icon: FileText,
      color: "bg-purple-500",
      link: "/bases/fortaleza/relatorios",
      status: "Ativo"
    },
    {
      id: 6,
    ...
    },
    {
      ...
      icon: DollarSign,
      color: "bg-indigo-500",
      link: "/bases/fortaleza/financeiro",
      status: "Ativo"
    },
    {
      id: 8,
    ...
    },
    {
      ...
      icon: Settings,
      color: "bg-gray-500",
      link: "/bases/fortaleza/configuracoes",
      status: "Ativo"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gerenciamento completo da Base Fortaleza
          </p>
        </div>
