    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Redirecionando para a Base ITUPEVA SSP38-SDD...",
        });
        navigate('/bases/itupeva');
      } else {
      ...
      <Card className="w-full max-w-md shadow-lg bg-white/90 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            ITUPEVA SSP38-SDD SSP38-SDD
          </CardTitle>
          <p className="text-gray-600">
            Faça login para acessar a Base ITUPEVA SSP38-SDD
          </p>
        </CardHeader>
        <CardContent>
