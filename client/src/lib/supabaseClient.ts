...
// CONFIGURAÇÃO CORRIGIDA: O sistema usa PostgreSQL local, não Supabase remoto
// Mantendo compatibilidade mas sinalizando que é apenas para estrutura de API
...
// IMPORTANTE: Este sistema não usa Supabase para dados reais - usa PostgreSQL local
console.warn('[SUPABASE] AVISO: Sistema configurado para usar PostgreSQL local, não Supabase remoto');
