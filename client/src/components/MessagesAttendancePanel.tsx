...
export default function MessagesAttendancePanel() {
  ...
  const pendingCount = conversations.filter(c => c.status === 'aberto' || c.status === 'em_atendimento').length;
  const respondedCount = conversations.filter(c => c.status === 'aguardando_motorista').length;
      ...
      <Card className="w-96 flex flex-col shadow-lg border-0">
        <CardHeader className="pb-3 border-b">
          <CardTitle className="flex items-center gap-2 text-lg">
            <MessageSquare className="h-5 w-5 text-[#E10613]" />
            Conversas
          </CardTitle>
          ...
          <div className="p-2 space-y-2">
            {filteredConversations.map(conv => (
              <div
                ...
                } ${conv.unreadCount > 0 ? 'border-l-4 border-l-[#E10613]' : ''}`}
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="font-bold font-mono text-gray-900">{conv.vehiclePlate}</span>
                    {conv.unreadCount > 0 && (
                      <span className="bg-[#E10613] text-white text-xs px-1.5 py-0.5 rounded-full">
                        {conv.unreadCount}
                      </span>
                    )}
                  </div>
            ...
            <div className="p-4 border-t bg-white">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="bg-[#E10613] hover:bg-[#B8050F] text-white px-6"
                >
