  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Lavagem */}
        <div className={`p-4 rounded-lg ${form.apenas_lavagem ? 'bg-green-100 border-2 border-green-300' : 'bg-green-50'}`}>
          <h3 className="text-lg font-semibold mb-4 text-green-800">
            Lavagem {form.apenas_lavagem && <span className="text-green-600">(Obrigatória)</span>}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              <input
                ...
                id="lavagem"
                name="lavagem"
                checked={form.lavagem || form.apenas_lavagem}
                onChange={handleChange}
                disabled={form.apenas_lavagem}
                className={`h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded ${form.apenas_lavagem ? 'cursor-not-allowed' : ''}`}
              />
              <label htmlFor="lavagem" className="ml-2 block text-sm font-medium text-gray-700">
                Realizar Lavagem {form.apenas_lavagem && <span className="text-gray-500">(Automático)</span>}
              </label>
            </div>

            {(form.lavagem || form.apenas_lavagem) && (
              <div>
                ...
                <select
                  ...
                  required={form.lavagem || form.apenas_lavagem}
                >
