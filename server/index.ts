  ...
  consumoDiarioPostosRoutes.get('/', async (req, res) => {
    res.status(200).json({
      ...
      data: [
        {
          posto: "OSASCO V2",
          tabelaOrigem: "abastecimentos_posto_osasco_v2",
          consumoDiario: [
        ...
        {
          posto: "GUARULHOS V2",
          tabelaOrigem: "abastecimentos_posto_guarulhos_v2",
          consumoDiario: [
            { data: "2025-05-20", litros: 380, abastecimentos: 10 },
            { data: "2025-05-19", litros: 420, abastecimentos: 12 },
            { data: "2025-05-18", litros: 320, abastecimentos: 8 }
          ],
          resumo: {
            totalLitros: 1120,
            totalAbastecimentos: 30,
            mediaDiaria: 373,
            diasComRegistro: 3
          }
        },
        {
          posto: "ALAIR V2",
          tabelaOrigem: "abastecimentos_posto_alair_v2",
          consumoDiario: [
            { data: "2025-05-20", litros: 280, abastecimentos: 8 },
            { data: "2025-05-19", litros: 310, abastecimentos: 9 },
            { data: "2025-05-18", litros: 250, abastecimentos: 7 }
          ],
          resumo: {
            totalLitros: 840,
