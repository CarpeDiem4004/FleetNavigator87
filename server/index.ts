...
(async () => {
  ...
  // Rotas de consumo diário de postos definidas diretamente aqui
  app.get('/api/consumo-diario-postos', unifiedAuthMiddleware, requireRoles(['admin', 'gestor']), async (req, res) => {
    try {
  ...
  app.get('/api/consumo-diario-postos/:posto', unifiedAuthMiddleware, requireRoles(['admin', 'gestor', 'operador']), async (req, res) => {
    try {
