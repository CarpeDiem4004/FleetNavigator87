...
export function setupAuth(app: Express) {
  ...
  app.post("/api/auth/login-base", async (req, res) => {
    ...
    try {
      ...
      if (!['operador', 'admin', 'gestor', 'posto', 'gestor_combustivel', 'operador_status_frota', 'line_hall', 'coordenador', 'oficina', 'pneus', 'operador_1_line_haul', 'gestor_equipamentos', 'gestor_frota', 'ceo', 'gerente_geral'].includes(user.role)) {
