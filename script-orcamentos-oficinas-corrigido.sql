-- SCRIPT CORRIGIDO para orçamentos enviados pelas OFICINAS para aprovação
...
SELECT 
    'DASHBOARD ORÇAMENTOS RECEBIDOS:' as info,
...
SELECT 'SUCESSO! Orçamentos das oficinas inseridos corretamente!' as resultado;