-- Script para criar a tabela abastecimentos_posto_campinas_v2
-- Observações:
...
BEGIN
    ...
    IF NEW.tipo_combustivel = 'Diesel' THEN
        SELECT diesel_nivel_atual INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF NEW.tipo_combustivel = 'Gasolina' THEN
        SELECT gasolina_nivel_atual INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF NEW.tipo_combustivel = 'Etanol' THEN
        SELECT etanol_nivel_atual INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF NEW.tipo_combustivel = 'Arla' THEN
        SELECT arla_nivel_atual INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF NEW.tipo_combustivel = 'S10' THEN
        SELECT s10_nivel_atual INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    END IF;
...
BEGIN
    ...
    IF NEW.valor_unitario IS NULL OR NEW.valor_unitario = 0 THEN
        ...
        ELSIF NEW.tipo_combustivel = 'Gasolina' THEN
            SELECT gasolina_valor_litro INTO NEW.valor_unitario FROM configuracao_tanques WHERE posto = 'Campinas_v2';
        ELSIF NEW.tipo_combustivel = 'Etanol' THEN
            SELECT etanol_valor_litro INTO NEW.valor_unitario FROM configuracao_tanques WHERE posto = 'Campinas_v2';
        ELSIF NEW.tipo_combustivel = 'Arla' THEN
            SELECT arla_valor_litro INTO NEW.valor_unitario FROM configuracao_tanques WHERE posto = 'Campinas_v2';
        ELSIF NEW.tipo_combustivel = 'S10' THEN
            SELECT s10_valor_litro INTO NEW.valor_unitario FROM configuracao_tanques WHERE posto = 'Campinas_v2';
        END IF;
    END IF;
...
BEGIN
    ...
    ELSIF p_tipo_combustivel = 'Gasolina' THEN
        SELECT gasolina_valor_litro INTO valor FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF p_tipo_combustivel = 'Etanol' THEN
        SELECT etanol_valor_litro INTO valor FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF p_tipo_combustivel = 'Arla' THEN
        SELECT arla_valor_litro INTO valor FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSIF p_tipo_combustivel = 'S10' THEN
        SELECT s10_valor_litro INTO valor FROM configuracao_tanques WHERE posto = 'Campinas_v2';
    ELSE
        valor := 0;
    END IF;
