-- Script corrigido para criar a tabela abastecimentos_posto_osasco_v2
-- Observações:
...
BEGIN
    ...
    IF NEW.tipo_combustivel = 'Diesel' THEN
        SELECT diesel_nivel INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Osasco_v2';
    ELSIF NEW.tipo_combustivel = 'Arla' THEN
        SELECT arla_nivel INTO NEW.nivel_tanque_apos FROM configuracao_tanques WHERE posto = 'Osasco_v2';
    END IF;
