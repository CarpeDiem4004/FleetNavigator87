-- Script corrigido para criar todas as tabelas do sistema de guincho
...
-- 4. Inserir alguns parceiros de exemplo (sem service_area e hourly_rate)
INSERT INTO towing_partners (name, company_name, phone, email, external_access_token) VALUES
('Claudio de Oliveira Silva', 'Guincho Express', '(11) 99999-0001', 'claudio@guinchoexpress.com', 'TESTE_CLAUDIO_DE_OLIVEIRA_SILVA_TOKEN'),
('Maria Santos', 'Reboque Rápido', '(11) 99999-0002', 'maria@reboqueerapido.com', 'TESTE_MARIA_SANTOS_TOKEN'),
('João Silva', 'Guincho 24h', '(11) 99999-0003', 'joao@guincho24h.com', 'TESTE_JOAO_SILVA_TOKEN'),
('Ana Costa', 'Socorro Auto', '(11) 99999-0004', 'ana@socorroauto.com', 'TESTE_ANA_COSTA_TOKEN'),
('Carlos Oliveira', 'Reboque Master', '(11) 99999-0005', 'carlos@reboquemaster.com', 'TESTE_CARLOS_OLIVEIRA_TOKEN')
