-- Script corrigido para criar estrutura completa de parceiros de guincho no Supabase
...
BEGIN
  ...
  IF (TG_OP = 'INSERT' OR TG_OP = 'UPDATE') THEN
    ...
    VALUES (
      ...
      NEW.notes, NEW.contato_nome, NEW.contato_telefone, NEW.status,
...
INSERT INTO towing_partners (id, name, company_name, contato_nome, contato_telefone, address, isactive) 
VALUES 
...
BEGIN
  ...
  FOR i IN 1..num_services LOOP
    ...
    INSERT INTO towing_service_notes (
      ...
      notes, contato_nome, contato_telefone, status, payment_status, 
