-- Script final compatível com a estrutura de tabelas existente no Supabase
-- Inclui tabelas, views e funções necessárias para o funcionamento do módulo

-- 1. Tabela de Parceiros de Guincho (atualização para colunas compatíveis)
...
INSERT INTO towing_partners (
  ...
  address, email, city, region, status
) 
VALUES 
  (5, 'Guincho Águia', 'Guincho Águia LTDA', 'José Silva', '11987654321', 
   'Av. Paulista, 1000, São Paulo, SP', 'contato@aguiaguincho.com.br', 'São Paulo', 'SP', 'active'),
  (6, 'Ford', 'Ford Serviços de Guincho Ltda', 'Atendimento Ford', '11912345678', 
   'Av. Industrial, 2500, São Bernardo do Campo, SP', 'guincho@ford.com.br', 'São Bernardo do Campo', 'SP', 'active'),
  (8, 'Caio Ramos de Souza', 'Ramos Guincho Express', 'Caio Ramos', '11998887766', 
   'Rua das Flores, 150, São Paulo, SP', 'caio@ramosguincho.com.br', 'São Paulo', 'SP', 'active'),
  (9, 'Claudio de Oliveira Silva', 'Oliveira Auto Socorro', 'Claudio Silva', '11977766655', 
   'Av. Interlagos, 1500, São Paulo, SP', 'claudio@oliveiraautosocorro.com.br', 'São Paulo', 'SP', 'active'),
  (10, 'Daiane do Vale Amaral', 'Vale Serviços de Guincho', 'Daiane Amaral', '11966655544', 
   'Rua Vergueiro, 2000, São Paulo, SP', 'daiane@valeguincho.com.br', 'São Paulo', 'SP', 'active'),
  (11, 'Delões Guinchos e Munck', 'Delões Guinchos e Munck LTDA', 'Roberto Delões', '11955544433', 
   'Av. das Nações Unidas, 12000, São Paulo, SP', 'contato@deloesguinchos.com.br', 'São Paulo', 'SP', 'active'),
  (12, 'Fluxo Guinchos', 'Fluxo Guinchos e Serviços LTDA', 'Amanda Fluxo', '11944433322', 
   'Av. Morumbi, 5000, São Paulo, SP', 'contato@fluxoguinchos.com.br', 'São Paulo', 'SP', 'active'),
  (15, 'Allan de Souza Vieira', 'Vieira Serviços Automotivos', 'Allan Vieira', '11933322211', 
   'Rua Augusta, 500, São Paulo, SP', 'allan@vieiraservicos.com.br', 'São Paulo', 'SP', 'active')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
