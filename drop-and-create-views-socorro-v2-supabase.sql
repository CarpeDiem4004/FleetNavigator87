-- Script para remover e recriar as views do posto Socorro_v2 no Supabase
-- Primeiro removemos as views existentes para evitar conflitos de tipo

-- Remoção das views existentes
...
-- Agora criamos as views novamente
...
SELECT
  ...
  r.valor_litro,
  r.valor_total,
  CAST('Sistema' AS VARCHAR(100)) AS responsavel, -- Garantir o mesmo tipo de dado
  r.nota_fiscal,
  r.fornecedor,
  r.observacoes
